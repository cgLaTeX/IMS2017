...
\begin{abstract}
  Conventional models of electromagnetic systems, with both radiation and scattering systems, are well understood. These involve standard boundary conditions. However, interesting and richer field topology can be found when examining systems with  dynamics. Here, we consider a disordered system of interacting quantum dots---nanoscale semiconductors with wide applicability in systems ranging from lasing to quantum computing to biological contrast imaging and next-generation displays. Quantum dots facilitate absorptive and emissive processes at specific frequencies over timescales independent of those in the incident radiation. We treat quantum dots \emph{semiclassically} to maintain the discrete dynamics inherent to quantum objects without resorting to second quantization to describe electromagnetic fields (i.e.\ fields behave classically). Our solution to the coupled systems proceeds via
  \begin{inparaenum}[(1)]
  ...
  The coupled solution of \cref{enum:step 1} and \cref{enum:step 2} produces a complete description of both the quantum and electromagnetic dynamics at each timestep. One can use this framework to study lasing effects, non-linear propagation, coupled Rabi oscillations, and other optical phenomena. Presentation of the theory, computational framework and interest physical data is the objective of this paper. 

%   Conventional models of electromagnetic systems, with both radiation and scattering systems, are well understood. These involve standard boundary conditions. However, interesting and richer field topology can be found when examining systems with  dynamics. Here, we consider a disordered system of interacting quantum dots---nanoscale semiconductors with wide applicability in systems ranging from lasing to quantum computing to biological contrast imaging and next-generation displays.
