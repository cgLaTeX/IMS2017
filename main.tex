...
The nonlinearities inherent in coupling \cref{eq:liouville} between dots places significant constraints on $\Delta t$. As one must choose $\Delta r_\text{min} > c \Delta t$ to
