...
Current full-wave solution strategies often resort to finite-difference or other mesh-based strategies\cite{Vanneste2001, Fratalocchi2008, Bachelard2015} for propagating fields throughout the simulation domain---techniques undermined by their computational overhead and numerical sensitivities\cite{Baczewski2013}.
...
Over the timescales required to advance the radiation dynamics significantly, the integral of the high frequency terms becomes vanishingly small and we may safely ignore them.
...
The integrated pulse angle (analogus to the $\pi$-pulse mentioned earlier) quantifies the intensity of the incident light.
